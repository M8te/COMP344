...
CREATE TABLE "Order" (
  ...
  Order_PaymentAuthorized NUMBER(1) NULL,
  Order_Picked NUMBER(1) NULL,
  Order_Shipped NUMBER(1) NULL,
  Order_ShipDate DATE NULL,
  Order_Paid NUMBER(1) NULL,
  ...
  Order_Shipping_TypeVARCHAR (45),
  Order_Payment_Confirmation_ID VARCHAR(45),
